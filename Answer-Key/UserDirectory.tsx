...
import { FACULTIES, STATUS_OPTIONS } from "../interview-app/src/DirectoryAPI.ts";
import { getPeople, addPerson, removePerson } from "../interview-app/src/DirectoryAPI.ts";
import type { Person, Faculty, Role, Status } from "../interview-app/src/DirectoryAPI.ts";
...
export default function UserDirectory() {
  ...
  const fetchPeople = async () => {
    setLoading(true);
    const results = await getPeople(query);
    if (!ignore) {
      setPeople(results);
      setLoading(false);
    }
